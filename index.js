window.addEventListener('load', () => {
  ...
  navigator.geolocation.watchPosition(
    position => {
      ...
      recordDiv.textContent = `${new Date(position.timestamp).toLocaleTimeString()} | ${position.coords.longitude}, ${position.coords.latitude} (${position.coords.accuracy} %) | ${position.coords.altitude} (${position.coords.altitudeAccuracy}) | ${position.coords.heading} | ${position.coords.speed} \n`;
